...
def second_chance_algorithm(memory_frames, pages):
    memory = []  # Marcos en memoria
    page_faults = 0  # Contador de fallos de página
    pointer = 0  # Apunta a la posición actual para el reemplazo
    ...
    for page_id in pages:
        ...
        if page_in_memory:
            ...
            if len(memory) < memory_frames:
                ...
                # Reemplazo usando Segunda Oportunidad
                while True:
...
if __name__ == "__main__":
    ...
    second_chance_algorithm(memory_frames, pages)
